...
![](/files/images/minard/Minard.png){.pure-img-responsive}
...
![](/files/images/minard/troops-1-1.png){.pure-img-responsive}
...
![](/files/images/minard/troops-2-1.png){.pure-img-responsive}
...
![](/files/images/minard/troops-3-1.png){.pure-img-responsive}
...
![](/files/images/minard/troops-4-1.png){.pure-img-responsive}
...
![](/files/images/minard/troops-5-1.png){.pure-img-responsive}
...
![](/files/images/minard/troops-map-1-1.png){.pure-img-responsive}
...
![](/files/images/minard/troops-map-2-1.png){.pure-img-responsive}
...
- You can supply `ggmap` with a four-number bounding box to get a specific region of a map. OpenStreetMap makes this really easy to do. Vavigate to the area you want to map at openstreetmap.org and click on "Export" in the top toolbar. The left sidebar should show the latitudes and longitudes for the current view. If you click on "Manually select a different area," you can create your own bounding box.
    ...
    ![](/files/images/minard/bounding-box.png){.pure-img-responsive}
...
![](/files/images/minard/show-europe-only-1.png){.pure-img-responsive}
...
![](/files/images/minard/get-tiles-wc-1.png){.pure-img-responsive}
...
![](/files/images/minard/europe-minard-1.png){.pure-img-responsive}
...
![](/files/images/minard/russia-minard-1.png){.pure-img-responsive}
...
![](/files/images/minard/temps-1-1.png){.pure-img-responsive}
...
![](/files/images/minard/temps-2-1.png){.pure-img-responsive}
...
![](/files/images/minard/align-example-1.png){.pure-img-responsive}
...
![](/files/images/minard/align-example-good-1.png){.pure-img-responsive}
...
![](/files/images/minard/align-minard-1.png){.pure-img-responsive}
...
![](/files/images/minard/adjust-panels-1.png){.pure-img-responsive}
...
![](/files/images/minard/combined-simple-1.png){.pure-img-responsive}
